...
def hello(request):
    return HttpResponse('Hello, World! from func')
...
class MonthPost(View):
    def get(self, request, year, month):
        text = ''
        ... #формирование статьи за год и месяц
...
def author_posts(request, author_id):
    ...
    posts = Post.objects.filter(author=author).order_by('-id')[:3]
